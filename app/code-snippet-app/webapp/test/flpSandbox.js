		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Code Snippet",
									"targetURL": "#comgaboappscodesnippetapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgaboappscodesnippetapp-display": {
								"semanticObject": "comgaboappscodesnippetapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gaboapps.codesnippetapp",
									"url": sap.ui.require.toUrl("com/gaboapps/codesnippetapp")
								}
							}
						}
					}
